...
#               1b) Define UI foreach row of a class
#                       i) One row per class
...
renderClassesAdded <- function(mode){
  ...
  # 1a) Initialize variables
  # ----------------------------------------------------------------------------
  # Lock other parts of code until this function finishes
  rv$doneClass = FALSE
  ...
  rv$classIndex = paste(input$uniqueClassesOutput, collapse = "; ")
  
  # Store pervious class data to repopulate data
  ...
  # ----------------------------------------------------------------------------
  # 1b) Define UI for each row of a class
  # ----------------------------------------------------------------------------
...
observeEvent(input$selectClassCol, {
  # update reactive variable for selected class column
