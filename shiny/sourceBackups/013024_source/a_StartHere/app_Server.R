...
appServer <- function(input,output,session){
  ...
  # Add classes by subcategory and relevant observeEvents
  source('source/b_Server/testData_initialPlots.R', local=TRUE)
  ...
  source('source/d_Graphs/dataImport_initialPlots.R', local=TRUE)
  
  # sourceCpp("source/c_C++Functions/test.cpp")
